...
<div class="yii-company-create">
    ...
    <?= $form->field($model, 'company_established_time')->textInput(['maxlength' => true, 'type' => 'date']) ?>  
    ...
    <div class="form-group field-createcompanyform-region_id required form-inline">
