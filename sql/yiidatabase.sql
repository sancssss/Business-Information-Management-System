...
-- ----------------------------
INSERT INTO `migration` VALUES ('m000000_000000_base', '1475117091');
...
-- ----------------------------
-- Table structure for `yii_enterprise_user_detail`
-- ----------------------------
DROP TABLE IF EXISTS `yii_enterprise_user_detail`;
CREATE TABLE `yii_enterprise_user_detail` (
  `user_id` int(20) NOT NULL,
  `user_nickname` varchar(20) NOT NULL COMMENT '用户姓名',
...
-- ----------------------------
-- Records of yii_enterprise_user_detail
-- ----------------------------
...
-- ----------------------------
INSERT INTO `yii_identity` VALUES ('1', '企业级用户');
INSERT INTO `yii_identity` VALUES ('2', '市县级管理部门');
INSERT INTO `yii_identity` VALUES ('3', '未审核企业');
INSERT INTO `yii_identity` VALUES ('4', '未审核市县级管理');
INSERT INTO `yii_identity` VALUES ('5', '超级管理员');
